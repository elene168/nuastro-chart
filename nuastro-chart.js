...
function draw(svgEl, result, mode){
  ...
  // For vedic: shift the ascendant by ayanamsa for wheel placement
  ...
  // ── FOUR AXIS LINES — always a perfect cross ─────────────────────────────────
  // ASC–DSC: always perfectly horizontal
  svgEl.appendChild(ln(cx-Ro,cy,cx+Ro,cy,'#111110',1.5));
  // MC–IC: always exactly vertical (90° from ASC = straight up/down)
  // This forms a perfect cross regardless of the actual MC ecliptic position
  svgEl.appendChild(ln(cx,cy-Ro,cx,cy+Ro,'#111110',1.5));

  // Labels — MC always top, IC always bottom
  ...
  svgEl.appendChild(tx('MC',cx,cy-Ro-14,lS));
  svgEl.appendChild(tx('IC',cx,cy+Ro+14,lS));
